...
def get_correct_verts(arc_centre, arc_start, arc_end, NUM_VERTS):
    ...
    normal1 = mathutils.geometry.normal(arc_centre, arc_end, arc_start)
    normal2 = mathutils.geometry.normal(arc_start, arc_centre, arc_end)
    print("NormalAxis1 =", normal1)
    print("NormalAxis1 =", normal1)
...
def draw_callback_px(self, context):
    ...
    if mode == 'TRIG':
        ...
        arc_start = knot1
        arc_end = knot2
        #arc_verts = get_correct_verts(arc_centre, arc_start, arc_end, NUM_VERTS)
        get_correct_verts(arc_centre, arc_start, arc_end, NUM_VERTS)
        pass 
