...
# [ ] enter to accept, and make real. esc/rclick to cancel.
...
class UIPanel(bpy.types.Panel):
    ...
    scn.FilletMode = bpy.props.EnumProperty( items =( ('TRIG', 'TRIG', ''),
                                            ('KAPPA', 'KAPPA', ''),
                                            ('TRIG_LAZY', 'LAZY', '') ),
...
class OBJECT_OT_draw_fillet(bpy.types.Operator):
    ...
    # i understand that a lot of these if's are redundant, scheduled for
    # deletion.
